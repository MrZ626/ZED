...
local UIscale=(SCR.w0^2+SCR.h0^2)^.5/1960*SCR.dpi
...
local touchMenu
local temp2nd=false
local function switchCap(arg)
    if arg=='temp' then
        touchMenu.Keyboard.list,touchMenu.Keyboard.list2=touchMenu.Keyboard.list2,touchMenu.Keyboard.list
        temp2nd=not temp2nd
    elseif arg=='lock' then
        touchMenu.Keyboard.list,touchMenu.Keyboard.list3=touchMenu.Keyboard.list3,touchMenu.Keyboard.list
    end
end
local function ZKB(arg)
    scene.keyDown(arg)
    if temp2nd then
        switchCap('temp')
    end
...
touchMenu={
    ...
    Menu.new{
        ...
        list={
            ...
            Menu.new{name='cap',    x=-1520,y=-180,r=60,color=COLOR.dR,func=switchCap,args='lock'},
            Menu.new{name='shift',  x=-1480,y=-60,r=60,color=COLOR.dR,func=switchCap,args='temp'},
        },
        list2={
            Menu.new{name='~',      x=-1590,y=-465,r=45,color=COLOR.dL,func=ZKB,args='~'},
            Menu.new{name='`',      x=-1500,y=-465,r=45,color=COLOR.dL,func=ZKB,args='`'},
            ...
            Menu.new{name='?',      x=-190, y=-165,r=55,color=COLOR.lR,func=ZKB,args='?'},
            Menu.new{name="</",     x=-62,  y=-155,r=68,color=COLOR.LB,func=ZKB,args="return"},
            ...
            Menu.new{name='SHIFT',  x=-1480,y=-60, r=60,color=COLOR.lY,func=switchCap,args='temp'},
        },
        list3={
            Menu.new{name='~',      x=-1590,y=-465,r=45,color=COLOR.dL,func=ZKB,args='~'},
            Menu.new{name='`',      x=-1500,y=-465,r=45,color=COLOR.dL,func=ZKB,args='`'},
            ...
            Menu.new{name='tAB',    x=-1560,y=-310,r=65,color=COLOR.lR,func=ZKB,args='shift+tab'},
            Menu.new{name='CAP',    x=-1520,y=-180,r=60,color=COLOR.lY,func=switchCap,args='lock'},
        },
    },
}
